...
/* The counter's own tests live with the other `dayProgress` cases further up. The
   three that stood here came from the second implementation of this feature and
   asserted the exam-counting behaviour that was not kept — see the note on
   `dayProgress` in classCalendar.js for why. */
